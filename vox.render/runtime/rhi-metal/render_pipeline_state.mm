...
RenderPipelineState::vertex_any_uploader{
    ...
    to_any_uploader < id <
    MTLBuffer >> ([](const id <MTLBuffer> &x, size_t location, id <MTLRenderCommandEncoder> encoder) {
        [encoder setVertexBuffer:x offset:0 atIndex:location];
    }),
    to_any_uploader < id <
    MTLTexture >> ([](const id <MTLTexture> &x, size_t location, id <MTLRenderCommandEncoder> encoder) {
