...
#include "../vox.geometry/transform.h"
...
TEST(Transform3, Constructors) {
  ...
  Transform3 t2({2.0, -5.0, 1.0}, Orientation<3>{QuaternionD({0.0, 1.0, 0.0}, kQuarterPiD)});
...
TEST(Transform3, Transform) {
  Transform3 t({2.0, -5.0, 1.0}, Orientation<3>{QuaternionD({0.0, 1.0, 0.0}, kHalfPiD)});
