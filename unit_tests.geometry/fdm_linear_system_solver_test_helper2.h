...
public:
  static void buildTestLinearSystem(FdmLinearSystem2 *system, const Vector2UZ &size) {
  ...
  static void buildTestCompressedLinearSystem(FdmCompressedLinearSystem2 *system, const Vector2UZ &size) {
