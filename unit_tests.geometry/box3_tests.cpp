...
TEST(Box3, ClosestIntersection) {
  ...
  SurfaceRayIntersection3 result0 =
      box.closestIntersection(Ray3D(Vector3D(1, 4, 5), Vector3D(-1, -1, -1).normalized()));
  ...
  SurfaceRayIntersection3 result1 =
      box.closestIntersection(Ray3D(Vector3D(1, 2.5, 6), Vector3D(-1, -1, 1).normalized()));
  ...
  SurfaceRayIntersection3 result2 =
      box.closestIntersection(Ray3D(Vector3D(1, 1, 2), Vector3D(-1, -1, -1).normalized()));
