...
public:
  static void buildTestLinearSystem(FdmLinearSystem3 *system, const Vector3UZ &size) {
  ...
  static void buildTestCompressedLinearSystem(FdmCompressedLinearSystem3 *system, const Vector3UZ &size) {
