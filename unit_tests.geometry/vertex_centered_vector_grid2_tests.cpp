...
#include "../vox.geometry/grids/vertex_centered_vector_grid.h"
...
TEST(VertexCenteredVectorGrid2, Builder) {
  {
    auto grid1 =
        VertexCenteredVectorGrid2::builder().build(Vector2UZ(3, 8), Vector2D(2.0, 3.0), Vector2D(1.0, 5.0), {4.0, 7.0});
