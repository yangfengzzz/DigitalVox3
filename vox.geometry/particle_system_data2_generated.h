...
CreateScalarParticleData2(flatbuffers::FlatBufferBuilder &_fbb,
...
CreateParticleNeighborList2(flatbuffers::FlatBufferBuilder &_fbb,
...
struct ParticleSystemData2Builder {
  ...
  void add_scalarDataList(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<ScalarParticleData2>>> scalarDataList) {
    fbb_.AddOffset(ParticleSystemData2::VT_SCALARDATALIST, scalarDataList);
  }
  void add_vectorDataList(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<VectorParticleData2>>> vectorDataList) {
  ...
  void add_neighborLists(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<ParticleNeighborList2>>> neighborLists) {
