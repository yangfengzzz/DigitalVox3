...
template <typename BlasType> struct MgVector {
...
using MgRelaxFunc = std::function<void(const typename BlasType::MatrixType &A, const typename BlasType::VectorType &b,
...
template <typename BlasType> struct MgParameters {
