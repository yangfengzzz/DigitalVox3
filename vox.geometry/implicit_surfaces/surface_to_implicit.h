...
//!
template <size_t N> class SurfaceToImplicit final : public ImplicitSurface<N> {
public:
  class Builder;
  ...
  explicit SurfaceToImplicit(const std::shared_ptr<Surface<N>> &surface, const Transform<N> &transform = Transform<N>(),
...
//!
template <size_t N>
class SurfaceToImplicit<N>::Builder final : public SurfaceBuilderBase<N, typename SurfaceToImplicit<N>::Builder> {
public:
