...
//!
template <size_t N> class PointHashGridSearcher final : public PointNeighborSearcher<N> {
public:
...
private:
  ...
  template <size_t M = N>
  static std::enable_if_t<M == 2, void> serialize(const PointHashGridSearcher<2> &searcher,
                                                  std::vector<uint8_t> *buffer);

  template <size_t M = N>
  static std::enable_if_t<M == 3, void> serialize(const PointHashGridSearcher<3> &searcher,
                                                  std::vector<uint8_t> *buffer);
...
//!
template <size_t N> class PointHashGridSearcher<N>::Builder final : public PointNeighborSearcherBuilder<N> {
public:
