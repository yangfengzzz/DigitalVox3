...
CreatePointHashGridSearcherBucket3(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<PointHashGridSearcherBucket3>
CreatePointHashGridSearcherBucket3Direct(flatbuffers::FlatBufferBuilder &_fbb,
                                         const std::vector<uint64_t> *data = nullptr) {
  return vox::geometry::fbs::CreatePointHashGridSearcherBucket3(_fbb, data ? _fbb.CreateVector<uint64_t>(*data) : 0);
}
...
struct PointHashGridSearcher3Builder {
  ...
  void
  add_buckets(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<PointHashGridSearcherBucket3>>> buckets) {
...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3Direct(
  ...
  return vox::geometry::fbs::CreatePointHashGridSearcher3(
...
inline const vox::geometry::fbs::PointHashGridSearcher3 *GetPointHashGridSearcher3(const void *buf) {
  return flatbuffers::GetRoot<vox::geometry::fbs::PointHashGridSearcher3>(buf);
}

inline bool VerifyPointHashGridSearcher3Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<vox::geometry::fbs::PointHashGridSearcher3>(nullptr);
}

inline void FinishPointHashGridSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb,
                                               flatbuffers::Offset<vox::geometry::fbs::PointHashGridSearcher3> root) {
  fbb.Finish(root);
}
