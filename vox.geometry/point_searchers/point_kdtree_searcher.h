...
//!
template <size_t N> class PointKdTreeSearcher final : public PointNeighborSearcher<N> {
public:
...
private:
  ...
  template <size_t M = N>
  static std::enable_if_t<M == 2, void> serialize(const PointKdTreeSearcher<2> &searcher, std::vector<uint8_t> *buffer);

  template <size_t M = N>
  static std::enable_if_t<M == 3, void> serialize(const PointKdTreeSearcher<3> &searcher, std::vector<uint8_t> *buffer);
...
//!
template <size_t N> class PointKdTreeSearcher<N>::Builder final : public PointNeighborSearcherBuilder<N> {
public:
