...
CreatePointKdTreeSearcher2Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return vox::geometry::fbs::CreatePointKdTreeSearcher2(_fbb, points ? _fbb.CreateVector<const vox::geometry::fbs::Vector2D *>(*points) : 0,
                                              nodes ? _fbb.CreateVector<const PointKdTreeSearcherNode2 *>(*nodes) : 0);
}

inline const vox::geometry::fbs::PointKdTreeSearcher2 *GetPointKdTreeSearcher2(const void *buf) {
  return flatbuffers::GetRoot<vox::geometry::fbs::PointKdTreeSearcher2>(buf);
}

inline bool VerifyPointKdTreeSearcher2Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<vox::geometry::fbs::PointKdTreeSearcher2>(nullptr);
}

inline void FinishPointKdTreeSearcher2Buffer(flatbuffers::FlatBufferBuilder &fbb,
                                             flatbuffers::Offset<vox::geometry::fbs::PointKdTreeSearcher2> root) {
  fbb.Finish(root);
}
