...
CreatePointSimpleListSearcher3(flatbuffers::FlatBufferBuilder &_fbb,
...
inline flatbuffers::Offset<PointSimpleListSearcher3>
CreatePointSimpleListSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb,
                                     const std::vector<const vox::geometry::fbs::Vector3D *> *points = nullptr) {
  return vox::geometry::fbs::CreatePointSimpleListSearcher3(_fbb,
                                                  points ? _fbb.CreateVector<const vox::geometry::fbs::Vector3D *>(*points) : 0);
}

inline const vox::geometry::fbs::PointSimpleListSearcher3 *GetPointSimpleListSearcher3(const void *buf) {
  return flatbuffers::GetRoot<vox::geometry::fbs::PointSimpleListSearcher3>(buf);
}

inline bool VerifyPointSimpleListSearcher3Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<vox::geometry::fbs::PointSimpleListSearcher3>(nullptr);
}

inline void FinishPointSimpleListSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb,
                                                 flatbuffers::Offset<vox::geometry::fbs::PointSimpleListSearcher3> root) {
  fbb.Finish(root);
}
