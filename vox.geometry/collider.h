...
//!
template <size_t N> class Collider {
public:
  //!
...
protected:
  ...
  void getClosestPoint(const std::shared_ptr<Surface<N>> &surface, const Vector<double, N> &queryPoint,
...
template <size_t N> using ColliderPtr = std::shared_ptr<Collider<N>>;
