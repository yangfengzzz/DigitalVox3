...
void VolumeGridEmitter2::addStepFunctionTarget(const ScalarGrid2Ptr &scalarGridTarget, double minValue,
                                               double maxValue) {
...
VolumeGridEmitter2Ptr VolumeGridEmitter2::Builder::makeShared() const {
  return std::shared_ptr<VolumeGridEmitter2>(new VolumeGridEmitter2(_sourceRegion, _isOneShot),
