...
class Bvh final : public IntersectionQueryEngine<T, N>, public NearestNeighborQueryEngine<T, N> {
public:
...
private:
  struct Node {
    ...
    void initInternal(uint8_t axis, size_t c, const BoundingBox<double, N> &b);
    bool isLeaf() const;
  };
...
//! 2-D BVH type.
template <typename T> using Bvh2 = Bvh<T, 2>;
