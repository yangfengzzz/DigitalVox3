...
template <typename T>
void FdmMgUtils2::resizeArrayWithCoarsest(const Vector2UZ &coarsestResolution, size_t numberOfLevels,
...
template <typename T>
void FdmMgUtils2::resizeArrayWithFinest(const Vector2UZ &finestResolution, size_t maxNumberOfLevels,
                                        std::vector<Array2<T>> *levels) {
