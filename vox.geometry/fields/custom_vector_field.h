...
public:
  ...
  //!
  explicit CustomVectorField(const std::function<Vector<double, N>(const Vector<double, N> &)> &customFunction,
  ...
  //! parameter.
  //!
  CustomVectorField(const std::function<Vector<double, N>(const Vector<double, N> &)> &customFunction,
...
//!
template <size_t N> class CustomVectorField<N>::Builder final {
public:
  //! Returns builder with field function.
  Builder &withFunction(const std::function<Vector<double, N>(const Vector<double, N> &)> &func);

  //! Returns builder with divergence function.
  Builder &withDivergenceFunction(const std::function<double(const Vector<double, N> &)> &func);

  //! Returns builder with curl function.
  Builder &withCurlFunction(const std::function<typename GetCurl<N>::type(const Vector<double, N> &)> &func);
