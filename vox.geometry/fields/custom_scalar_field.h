...
public:
  ...
  //!
  explicit CustomScalarField(const std::function<double(const Vector<double, N> &)> &customFunction,
  ...
  //! parameter.
  //!
  CustomScalarField(const std::function<double(const Vector<double, N> &)> &customFunction,
...
private:
  ...
  std::function<Vector<double, N>(const Vector<double, N> &)> _customGradientFunction;
...
//!
template <size_t N> class CustomScalarField<N>::Builder final {
public:
