...
public:
  ...
  //!
  virtual void extrapolate(const ScalarGrid3 &input, const ScalarField3 &sdf, double maxDistance,
  ...
  //!
  virtual void extrapolate(const CollocatedVectorGrid3 &input, const ScalarField3 &sdf, double maxDistance,
  ...
  //!
  virtual void extrapolate(const FaceCenteredGrid3 &input, const ScalarField3 &sdf, double maxDistance,
