...
//!
template <size_t N> class ParticleSystemData : public Serializable {
public:
  //! Scalar data chunk.
  ...
  //!
  void addParticle(const Vector<double, N> &newPosition, const Vector<double, N> &newVelocity = Vector<double, N>(),
...
protected:
  template <size_t M = N>
  static std::enable_if_t<M == 2, void> serialize(const ParticleSystemData<2> &particles,
                                                  flatbuffers::FlatBufferBuilder *builder,
                                                  flatbuffers::Offset<fbs::ParticleSystemData2> *fbsParticleSystemData);

  template <size_t M = N>
  static std::enable_if_t<M == 3, void> serialize(const ParticleSystemData<3> &particles,
                                                  flatbuffers::FlatBufferBuilder *builder,
                                                  flatbuffers::Offset<fbs::ParticleSystemData3> *fbsParticleSystemData);

  template <size_t M = N>
  static std::enable_if_t<M == 2, void> deserialize(const fbs::ParticleSystemData2 *fbsParticleSystemData,
                                                    ParticleSystemData<2> &particles);

  template <size_t M = N>
  static std::enable_if_t<M == 3, void> deserialize(const fbs::ParticleSystemData3 *fbsParticleSystemData,
...
private:
  ...
  size_t _positionIdx = 0;
  size_t _velocityIdx = 0;
  size_t _forceIdx = 0;
...
template <size_t N> using ParticleSystemDataPtr = std::shared_ptr<ParticleSystemData<N>>;
