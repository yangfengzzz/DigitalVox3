...
public:
  ...
  //!
  virtual void extrapolate(const ScalarGrid2 &input, const ScalarField2 &sdf, double maxDistance,
  ...
  //!
  virtual void extrapolate(const CollocatedVectorGrid2 &input, const ScalarField2 &sdf, double maxDistance,
  ...
  //!
  virtual void extrapolate(const FaceCenteredGrid2 &input, const ScalarField2 &sdf, double maxDistance,
