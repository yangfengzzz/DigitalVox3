...
//!
template <size_t N> class VertexCenteredVectorGrid final : public CollocatedVectorGrid<N> {
public:
  ...
  //! initial value.
  explicit VertexCenteredVectorGrid(const Vector<size_t, N> &resolution,
...
template <size_t N> class VertexCenteredVectorGrid<N>::Builder final : public VectorGridBuilder<N> {
public:
