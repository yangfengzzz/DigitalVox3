...
struct ScalarGrid3Builder {
  ...
  void add_resolution(const vox::fbs::Vector3UZ *resolution) { fbb_.AddStruct(ScalarGrid3::VT_RESOLUTION, resolution); }
  void add_gridSpacing(const vox::fbs::Vector3D *gridSpacing) {
    fbb_.AddStruct(ScalarGrid3::VT_GRIDSPACING, gridSpacing);
  }
  void add_origin(const vox::fbs::Vector3D *origin) { fbb_.AddStruct(ScalarGrid3::VT_ORIGIN, origin); }
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return vox::fbs::CreateScalarGrid3(_fbb, resolution, gridSpacing, origin,
