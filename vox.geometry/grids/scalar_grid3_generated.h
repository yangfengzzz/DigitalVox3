...
struct ScalarGrid3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const vox::geometry::fbs::Vector3D *gridSpacing() const { return GetStruct<const vox::geometry::fbs::Vector3D *>(VT_GRIDSPACING); }
  const vox::geometry::fbs::Vector3D *origin() const { return GetStruct<const vox::geometry::fbs::Vector3D *>(VT_ORIGIN); }
  const flatbuffers::Vector<double> *data() const { return GetPointer<const flatbuffers::Vector<double> *>(VT_DATA); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<vox::geometry::fbs::Vector3UZ>(verifier, VT_RESOLUTION) &&
           VerifyField<vox::geometry::fbs::Vector3D>(verifier, VT_GRIDSPACING) &&
           VerifyField<vox::geometry::fbs::Vector3D>(verifier, VT_ORIGIN) && VerifyOffset(verifier, VT_DATA) &&
...
struct ScalarGrid3Builder {
  ...
  void add_resolution(const vox::geometry::fbs::Vector3UZ *resolution) { fbb_.AddStruct(ScalarGrid3::VT_RESOLUTION, resolution); }
  void add_gridSpacing(const vox::geometry::fbs::Vector3D *gridSpacing) {
    fbb_.AddStruct(ScalarGrid3::VT_GRIDSPACING, gridSpacing);
  }
  void add_origin(const vox::geometry::fbs::Vector3D *origin) { fbb_.AddStruct(ScalarGrid3::VT_ORIGIN, origin); }
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3(flatbuffers::FlatBufferBuilder &_fbb,
                                                          ...
                                                          const vox::geometry::fbs::Vector3D *gridSpacing = 0,
                                                          const vox::geometry::fbs::Vector3D *origin = 0,
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return vox::geometry::fbs::CreateScalarGrid3(_fbb, resolution, gridSpacing, origin,
                                     data ? _fbb.CreateVector<double>(*data) : 0);
}

inline const vox::geometry::fbs::ScalarGrid3 *GetScalarGrid3(const void *buf) {
  return flatbuffers::GetRoot<vox::geometry::fbs::ScalarGrid3>(buf);
}

inline bool VerifyScalarGrid3Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<vox::geometry::fbs::ScalarGrid3>(nullptr);
}

inline void FinishScalarGrid3Buffer(flatbuffers::FlatBufferBuilder &fbb,
                                    flatbuffers::Offset<vox::geometry::fbs::ScalarGrid3> root) {
  fbb.Finish(root);
}
