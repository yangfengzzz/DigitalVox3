...
//!
template <size_t N> class CellCenteredVectorGrid final : public CollocatedVectorGrid<N> {
public:
  ...
  //! initial value.
  explicit CellCenteredVectorGrid(const Vector<size_t, N> &resolution,
...
//!
template <size_t N> class CellCenteredVectorGrid<N>::Builder final : public VectorGridBuilder<N> {
public:
