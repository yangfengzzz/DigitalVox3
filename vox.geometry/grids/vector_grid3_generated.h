...
struct VectorGrid3Builder {
  ...
  void add_resolution(const vox::geometry::fbs::Vector3UZ *resolution) { fbb_.AddStruct(VectorGrid3::VT_RESOLUTION, resolution); }
  void add_gridSpacing(const vox::geometry::fbs::Vector3D *gridSpacing) {
    fbb_.AddStruct(VectorGrid3::VT_GRIDSPACING, gridSpacing);
  }
  void add_origin(const vox::geometry::fbs::Vector3D *origin) { fbb_.AddStruct(VectorGrid3::VT_ORIGIN, origin); }
...
inline flatbuffers::Offset<VectorGrid3> CreateVectorGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return vox::geometry::fbs::CreateVectorGrid3(_fbb, resolution, gridSpacing, origin,
                                     data ? _fbb.CreateVector<double>(*data) : 0);
}

inline const vox::geometry::fbs::VectorGrid3 *GetVectorGrid3(const void *buf) {
  return flatbuffers::GetRoot<vox::geometry::fbs::VectorGrid3>(buf);
}

inline bool VerifyVectorGrid3Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<vox::geometry::fbs::VectorGrid3>(nullptr);
}

inline void FinishVectorGrid3Buffer(flatbuffers::FlatBufferBuilder &fbb,
                                    flatbuffers::Offset<vox::geometry::fbs::VectorGrid3> root) {
  fbb.Finish(root);
}
