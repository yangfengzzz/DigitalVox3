...
//!
template <size_t N> class CellCenteredScalarGrid final : public ScalarGrid<N> {
public:
  ...
  //! initial value.
  explicit CellCenteredScalarGrid(const Vector<size_t, N> &resolution,
...
//!
template <size_t N> class CellCenteredScalarGrid<N>::Builder final : public ScalarGridBuilder<N> {
public:
