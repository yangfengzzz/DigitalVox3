...
struct ScalarGrid2Builder {
  ...
  void add_resolution(const vox::fbs::Vector2UZ *resolution) { fbb_.AddStruct(ScalarGrid2::VT_RESOLUTION, resolution); }
  void add_gridSpacing(const vox::fbs::Vector2D *gridSpacing) {
    fbb_.AddStruct(ScalarGrid2::VT_GRIDSPACING, gridSpacing);
  }
  void add_origin(const vox::fbs::Vector2D *origin) { fbb_.AddStruct(ScalarGrid2::VT_ORIGIN, origin); }
...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return vox::fbs::CreateScalarGrid2(_fbb, resolution, gridSpacing, origin,
