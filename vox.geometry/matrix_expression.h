...
template <size_t Rows, size_t Cols> constexpr bool isMatrixSizeDynamic() {
  return (Rows == kMatrixSizeDynamic) || (Cols == kMatrixSizeDynamic);
}

template <size_t Rows, size_t Cols> constexpr bool isMatrixSizeStatic() { return !isMatrixSizeDynamic<Rows, Cols>(); }

template <size_t Rows, size_t Cols> constexpr bool isMatrixStaticSquare() {
  return isMatrixSizeStatic<Rows, Cols>() && (Rows == Cols);
}

template <size_t Rows, size_t Cols> struct IsMatrixSizeDynamic {
  static const bool value = isMatrixSizeDynamic<Rows, Cols>();
};

template <size_t Rows, size_t Cols> struct IsMatrixSizeStatic {
  static const bool value = isMatrixSizeStatic<Rows, Cols>();
};

template <size_t Rows, size_t Cols> struct IsMatrixSizeSquare {
  static const bool value = isMatrixStaticSquare<Rows, Cols>();
};

template <typename T, size_t Rows, size_t Cols> class Matrix;

template <typename T, size_t Rows, size_t Cols, typename M1> class MatrixDiagonal;

template <typename T, size_t Rows, size_t Cols, typename M1> class MatrixOffDiagonal;

template <typename T, size_t Rows, size_t Cols, typename M1> class MatrixTri;

template <typename T, size_t Rows, size_t Cols, typename M1> class MatrixTranspose;

template <typename T, size_t Rows, size_t Cols, typename M1, typename UnaryOperation> class MatrixUnaryOp;
...
public:
  ...
  template <size_t R, size_t C, typename E> value_type distanceTo(const MatrixExpression<T, R, C, E> &other) const;

  //! Returns the squared distance to the other vector.
  template <size_t R, size_t C, typename E>
  value_type distanceSquaredTo(const MatrixExpression<T, R, C, E> &other) const;
  ...
  template <typename U> MatrixUnaryOp<U, Rows, Cols, const Derived &, TypeCast<T, U>> castTo() const;
...
protected:
  ...
  template <typename U = value_type>
  static std::enable_if_t<(Rows > 4 && Cols > 4) || isMatrixSizeDynamic<Rows, Cols>(), U>
...
class MatrixConstant : public MatrixExpression<T, Rows, Cols, MatrixConstant<T, Rows, Cols>> {
public:
  constexpr MatrixConstant(size_t r, size_t c, const T &val) : _rows(r), _cols(c), _val(val) {}
...
class MatrixDiagonal : public MatrixExpression<T, Rows, Cols, MatrixDiagonal<T, Rows, Cols, M1>> {
public:
...
template <typename T, size_t Rows, size_t Cols, typename M1>
class MatrixOffDiagonal : public MatrixExpression<T, Rows, Cols, MatrixOffDiagonal<T, Rows, Cols, M1>> {
public:
...
template <typename T, size_t Rows, size_t Cols, typename M1>
class MatrixTri : public MatrixExpression<T, Rows, Cols, MatrixTri<T, Rows, Cols, M1>> {
public:
  constexpr MatrixTri(const M1 &m1, bool isUpper, bool isStrict) : _m1(m1), _isUpper(isUpper), _isStrict(isStrict) {}
...
template <typename T, size_t Rows, size_t Cols, typename M1>
class MatrixTranspose : public MatrixExpression<T, Rows, Cols, MatrixTranspose<T, Rows, Cols, M1>> {
public:
...
class MatrixUnaryOp : public MatrixExpression<T, Rows, Cols, MatrixUnaryOp<T, Rows, Cols, M1, UnaryOperation>> {
public:
...
//!
template <typename T, size_t Rows, size_t Cols, typename E1, typename E2, typename BinaryOperation>
class MatrixElemWiseBinaryOp
    : public MatrixExpression<T, Rows, Cols, MatrixElemWiseBinaryOp<T, Rows, Cols, E1, E2, BinaryOperation>> {
public:
  constexpr MatrixElemWiseBinaryOp(const E1 &m1, const E2 &m2) : _m1(m1), _m2(m2) {}
...
template <typename T, size_t Rows, size_t Cols, typename M1, typename BinaryOperation>
class MatrixScalarElemWiseBinaryOp
    : public MatrixExpression<T, Rows, Cols, MatrixScalarElemWiseBinaryOp<T, Rows, Cols, M1, BinaryOperation>> {
public:
  constexpr MatrixScalarElemWiseBinaryOp(const M1 &m1, const T &s2) : _m1(m1), _s2(s2) {}
...
template <typename T, size_t Rows, size_t Cols, typename M2, typename BinaryOperation>
class ScalarMatrixElemWiseBinaryOp
    : public MatrixExpression<T, Rows, Cols, ScalarMatrixElemWiseBinaryOp<T, Rows, Cols, M2, BinaryOperation>> {
public:
  constexpr ScalarMatrixElemWiseBinaryOp(const T &s1, const M2 &m2) : _s1(s1), _m2(m2) {}
...
template <typename T, size_t Rows, size_t Cols, typename M1, typename M2, typename M3, typename TernaryOperation>
class MatrixTernaryOp
    : public MatrixExpression<T, Rows, Cols, MatrixTernaryOp<T, Rows, Cols, M1, M2, M3, TernaryOperation>> {
public:
  constexpr MatrixTernaryOp(const M1 &m1, const M2 &m2, const M3 &m3) : _m1(m1), _m2(m2), _m3(m3) {}
...
template <typename T, size_t Rows, size_t Cols, typename M1, typename M2>
class MatrixMul : public MatrixExpression<T, Rows, Cols, MatrixMul<T, Rows, Cols, M1, M2>> {
public:
