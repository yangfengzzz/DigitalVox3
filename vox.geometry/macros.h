...
#define JET_CUDA_CHECK(expression) _JET_CUDA_CHECK((expression), #expression, __FILE__, __LINE__)

#define JET_CUDA_CHECK_LAST_ERROR(msg) _JET_CUDA_CHECK(cudaGetLastError(), msg, __FILE__, __LINE__)
