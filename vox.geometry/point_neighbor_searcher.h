...
//! origin point.
//!
template <size_t N> class PointNeighborSearcher : public Serializable {
public:
  ...
  //!
  virtual void forEachNearbyPoint(const Vector<double, N> &origin, double radius,
  ...
  //!
  virtual bool hasNearbyPoint(const Vector<double, N> &origin, double radius) = 0;
...
template <size_t N> class PointNeighborSearcherBuilder {
public:
