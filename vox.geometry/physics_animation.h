...
public:
  ...
  //!
  //! \brief      Returns true if fixed sub-time_stepping is used.
  //!
  //! When performing a time-integration, it is often required to take
  //! sub-time_stepping for better results. The sub-stepping can be either
  ...
  //!
  [[nodiscard]] bool isUsingFixedSubTimeSteps() const;

  //!
  //! \brief      Sets true if fixed sub-time_stepping is used.
  //!
  //! When performing a time-integration, it is often required to take
  //! sub-time_stepping for better results. The sub-stepping can be either
  ...
  //!
  //! \brief      Returns the number of fixed sub-time_steps.
  //!
  //! When performing a time-integration, it is often required to take
  //! sub-time_stepping for better results. The sub-stepping can be either
  ...
  //! sub-steps.
  //!
  //! \return     The number of fixed sub-time_steps.
  //!
  [[nodiscard]] unsigned int numberOfFixedSubTimeSteps() const;

  //!
  //! \brief      Sets the number of fixed sub-time_steps.
  //!
  //! When performing a time-integration, it is often required to take
  //! sub-time_stepping for better results. The sub-stepping can be either
  ...
  //! sub-steps.
  //!
  //! \param[in]  numberOfSteps The number of fixed sub-time_steps.
  //!
  ...
  //! current frame + sub-time_steps it passed.
  //!
  [[nodiscard]] double currentTimeInSeconds() const;
...
protected:
  ...
  //!
  //! \brief      Returns the required number of sub-time_steps for given time
  //!             interval.
  //!
  //! The required number of sub-time_step can be different depending on the
  //! physics model behind the implementation. Override this function to
  //! implement own logic for model specific sub-time_stepping for given
  //! time interval.
  //!
  //! \param[in]  timeIntervalInSeconds The time interval in seconds.
  //!
  //! \return     The required number of sub-time_steps.
  //!
  [[nodiscard]] virtual unsigned int numberOfSubTimeSteps(double timeIntervalInSeconds) const;
