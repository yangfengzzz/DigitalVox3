...
template <typename T, size_t N> class ArrayView final : public ArrayBase<T, N, ArrayView<T, N>> {
...
public:
  ...
  template <size_t M = N> ArrayView(typename std::enable_if_t<(M == 1), T *> ptr, size_t size_);
...
public:
  ...
  template <size_t M = N> ArrayView(typename std::enable_if_t<(M == 1), const T *> ptr, size_t size_);
...
template <class T> using ArrayView1 = ArrayView<T, 1>;

template <class T> using ArrayView2 = ArrayView<T, 2>;

template <class T> using ArrayView3 = ArrayView<T, 3>;

template <class T> using ArrayView4 = ArrayView<T, 4>;

template <class T> using ConstArrayView1 = ArrayView<const T, 1>;

template <class T> using ConstArrayView2 = ArrayView<const T, 2>;

template <class T> using ConstArrayView3 = ArrayView<const T, 3>;
