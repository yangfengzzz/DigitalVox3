...
void ParticleSystemSolver2::resolveCollision() { resolveCollision(_newPositions, _newVelocities); }

void ParticleSystemSolver2::resolveCollision(ArrayView1<Vector2D> newPositions, ArrayView1<Vector2D> newVelocities) {
...
ParticleSystemSolver2Ptr ParticleSystemSolver2::Builder::makeShared() const {
  return std::shared_ptr<ParticleSystemSolver2>(new ParticleSystemSolver2(_radius, _mass),
