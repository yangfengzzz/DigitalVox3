...
//! \brief Returns divergence value from given 3-D vector grid-like array
//!        \p data, \p gridSpacing, and array index (\p i, \p j, \p k).
...
template <size_t N> struct GetFdmUtils {};

template <> struct GetFdmUtils<2> {
