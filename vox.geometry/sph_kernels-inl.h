...
inline SphStdKernel2::SphStdKernel(double h_) : h(h_), h2(h * h), h3(h2 * h), h4(h2 * h2) {}
...
inline SphSpikyKernel2::SphSpikyKernel(double h_) : h(h_), h2(h * h), h3(h2 * h), h4(h2 * h2), h5(h3 * h2) {}
...
inline SphStdKernel3::SphStdKernel(double kernelRadius) : h(kernelRadius), h2(h * h), h3(h2 * h), h5(h2 * h3) {}
...
inline SphSpikyKernel3::SphSpikyKernel(double h_) : h(h_), h2(h * h), h3(h2 * h), h4(h2 * h2), h5(h3 * h2) {}
