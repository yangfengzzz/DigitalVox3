...
class MatrixCsrMatrixMul
    : public MatrixExpression<T, kMatrixSizeDynamic, kMatrixSizeDynamic, MatrixCsrMatrixMul<T, ME>> {
public:
...
//!
template <typename T>
class MatrixCsr final : public MatrixExpression<T, kMatrixSizeDynamic, kMatrixSizeDynamic, MatrixCsr<T>> {
public:
  ...
  using IndexIterator = typename IndexContainerType::iterator;
  using ConstIndexIterator = typename IndexContainerType::const_iterator;
  ...
  template <size_t R, size_t C, typename ME> void imul(const MatrixExpression<T, R, C, ME> &m);
  ...
  template <typename U> MatrixCsr<U> castTo() const;
  ...
  //! stored.
  //!
  template <size_t R, size_t C, typename ME> MatrixCsr &operator=(const MatrixExpression<T, R, C, ME> &m);
...
private:
  ...
  template <typename Op> MatrixCsr binaryOp(const MatrixCsr &m, Op op) const;
};
