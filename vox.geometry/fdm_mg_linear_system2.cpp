...
#include "fdm_solvers/fdm_gauss_seidel_solver2.h"
...
void FdmMgLinearSystem2::resizeWithCoarsest(const Vector2UZ &coarsestResolution, size_t numberOfLevels) {
...
void FdmMgLinearSystem2::resizeWithFinest(const Vector2UZ &finestResolution, size_t maxNumberOfLevels) {
