...
void FdmMgLinearSystem3::resizeWithCoarsest(const Vector3UZ &coarsestResolution, size_t numberOfLevels) {
...
void FdmMgLinearSystem3::resizeWithFinest(const Vector3UZ &finestResolution, size_t maxNumberOfLevels) {
