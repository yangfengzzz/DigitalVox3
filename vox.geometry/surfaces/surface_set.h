...
//! surface instances.
//!
template <size_t N> class SurfaceSet final : public Surface<N> {
public:
  class Builder;
...
//!
template <size_t N> class SurfaceSet<N>::Builder final : public SurfaceBuilderBase<N, SurfaceSet<N>::Builder> {
public:
