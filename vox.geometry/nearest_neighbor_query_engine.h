...
template <typename T> using NearestNeighborQueryResult2 = NearestNeighborQueryResult<T, 2>;

//! 3-D nearest neighbor query result.
template <typename T> using NearestNeighborQueryResult3 = NearestNeighborQueryResult<T, 3>;
...
template <typename T> using NearestNeighborDistanceFunc2 = NearestNeighborDistanceFunc<T, 2>;

//! 3-D nearest neighbor distance measure function.
template <typename T> using NearestNeighborDistanceFunc3 = NearestNeighborDistanceFunc<T, 3>;

//! Abstract base class for N-D nearest neighbor query engine.
template <typename T, size_t N> class NearestNeighborQueryEngine {
public:
  virtual ~NearestNeighborQueryEngine() = default;

  //! Returns the nearest neighbor for given point and distance measure
  //! function.
  virtual NearestNeighborQueryResult<T, N> nearest(const Vector<double, N> &pt,
                                                   const NearestNeighborDistanceFunc<T, N> &distanceFunc) const = 0;
};

//! Abstract base class for 2-D nearest neighbor query engine.
template <typename T> using NearestNeighborQueryEngine2 = NearestNeighborQueryEngine<T, 2>;
